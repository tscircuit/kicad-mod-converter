...
import { convertDirectory } from "./cmds"
...
program
  ...
  .requiredOption("-i, --input-dir <input>", "Input directory")
  .requiredOption("-o, --output-dir <output>", "Output directory")
  .action((opts) => convertDirectory(opts))
